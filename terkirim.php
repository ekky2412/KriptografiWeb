...
include "koneksi.php";
$query = "SELECT * FROM pesan WHERE email_pengirim = '" . $_SESSION['email'] . "'";
$data = mysqli_query($conn, $query);

// QUERY SELECT PESAN WHERE email pengirim = 
                ...
                <form action="terkirim.php" method="get">
                    ...
                    ?>
                            <div class="border p-2">
                                <div class="row">
                                    <a class="btn btn-outline-dark" href="terkirim.php?id=<?= $row['id_pesan'] ?>"><b> To : <?= $row['email_penerima'] ?> </b> Subject :  <?=$row['subject'] ?> <a>
                                </div>
